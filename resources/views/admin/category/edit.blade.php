          ...
          <h4 class="card-title">Update Category</h4>
            ...
            @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="category_en"  value="{{ $category->category_en }}" placeholder="Enter your category name (English)">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="category_bg"  value="{{ $category->category_bg }}" placeholder="Enter your category name (Bangla)">
                    @error('category_bg')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
