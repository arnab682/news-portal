...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        ...
        <h4 class="card-title">Update District</h4>
            ...
            <form class="forms-sample" method="POST" action="{{ route('admin.update.district',$district->id) }}">
             @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="district_bg"  value="{{ $district->district_bg }}">
                    @error('district_bg')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
