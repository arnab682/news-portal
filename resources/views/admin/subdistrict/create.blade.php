...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        ...
        <form class="forms-sample" method="POST" action="{{ route('admin.store.subdistrict') }}">
          @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="subdistrict_bg"  placeholder="SubDistrict Bangla">
                @error('subdistrict_bg')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
