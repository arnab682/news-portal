...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        ...
        <form class="forms-sample" method="POST" action="{{ route('admin.update.subdistrict',$subdistrict->id) }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="subdistrict_bg"  value="{{ $subdistrict->subdistrict_bg }}">
