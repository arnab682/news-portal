...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        ...
        <form class="forms-sample" method="POST" action="{{ route('admin.store.subcategory') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcategory_bg"  placeholder="SubCategory Bangla">
