...
<div class="col-12 grid-margin stretch-card">
 ...
 <form class="forms-sample" action="{{ route('admin.update.post',$post->id ) }}" method="post" enctype="multipart/form-data">
  @csrf
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <textarea class="form-control" name="details_bg" id="summernote1">
       {{ $post->details_bg }}
    </textarea>
                      </div>
