...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        ...
        <form class="forms-sample" action="{{ route('admin.store.post') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <input type="text" class="form-control" id="exampleInputName1" name="title_bg">
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="exampleSelectGender" name="district_id">
                        ...
                        @foreach($district as $row)
                            <option value="{{ $row->id }}">{{ $row->district_en  }} | {{ $row-> district_bg  }}</option>
                        @endforeach
                   </select>
                </div>
            ...
            <div class="row">
                ...
                <input type="text" class="form-control" id="exampleInputName1" name="tags_bg">
                </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="details_bg" id="summernote1"></textarea>
            </div>
